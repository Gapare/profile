...
class Project(models.Model):
   ...
   # live_url = models.URLField(blank=True)
    ...
    apk_file = models.FileField(upload_to="apks/", blank=True, null=True, storage=default_storage)
    #version = models.CharField(max_length=10, default="1.0.0") # Good for tracking updates
